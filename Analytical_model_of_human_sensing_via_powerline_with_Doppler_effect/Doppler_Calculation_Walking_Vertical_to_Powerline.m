% --------------------------------------------------------------------------------------------------
%
%    Analytical Model of Human Walking Vertically to Powerline by Calculating Doppler Signature. 
%
...
Py_human=abs(Vy_max)*T+1:Vy_max*dt:1;
d=3;                                    % distance between human and y axis
Pz_human=ones(1,Nt)*d;

% velocity of human
Vx=zeros(1,length(Px_human));
Vy=ones(1,length(Py_human))*Vy_max;
